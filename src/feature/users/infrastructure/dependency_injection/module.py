# ==========================================
# CORRECCIÓN: src/feature/users/infrastructure/dependency_injection/module.py
# ==========================================

"""
Users Module - Configuración DI específica del feature Users
"""
...
class UsersModule:
    """Module que configura servicios de Users en el ServiceRegistry global"""

    @staticmethod
    def configure():
        """Configurar servicios del feature Users"""
    ...
    # Factory methods privados - CORREGIDOS CON IMPORTS ABSOLUTOS
    @staticmethod
