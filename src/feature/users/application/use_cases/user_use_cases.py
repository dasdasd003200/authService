...
class UserUseCases:
    """Updated use cases to work with generic Criteria"""

    def __init__(self, user_repository: UserRepository):
        self.user_repository = user_repository

    # ===== NEW METHODS USING GENERIC CRITERIA =====

    async def find_users_with_criteria(self, prepare: PrepareFind) -> Tuple[List[User], int]:
        """Find users using generic Criteria - like your NestJS zDispatch"""
    ...
    async def find_user_one_with_criteria(self, prepare: PrepareFindOne) -> Optional[User]:
        """Find one user using generic Criteria - like your NestJS zDispatch"""
